...
class DummyMovableObject : public MovableObject {
 public:
  DummyMovableObject(const float velocity, const HitBoxVariant& hit_box)
      : MovableObject(
